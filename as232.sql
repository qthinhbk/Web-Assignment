...
INSERT INTO `comments` (`product_id`, `customer_id`, `content`, `created_at`)
VALUES (1, 2, 'Dưa ngon và ngọt nước như quảng cáo!', '2022-07-01 08:14:06'),
...
INSERT INTO `products` (`id`, `category_id`, `name`, `qty`, `price`, `img_url`, `description`)
VALUES (1, 1, 'Dưa lưới vỏ xanh', 10, 45000, '/products/11.png',
        'Quả tròn, thịt màu cam, rất thơm và ngọt, độ đường 14 - 15%, trái nặng 1,3 - 1,5 kg.'),
       (2, 1, 'Dưa hoàng kim', 20, 40000, '/products/12.png',
        'Dưa Vàng Kim Hoàng Hậu. Trọng lượng quả 1,8kg/quả. Độ Brix >= 14.'),
       (3, 1, 'Nho xanh không hạt', 25, 250000, '/products/13.png',
        'Nho xanh Úc là một trong những giống nho phổ biến và được yêu thích nhất hiện nay, phần vỏ màu xanh lá cây khi chín ngả sang màu vàng, quả hình bầu dục, thịt dày chắc ngọt, nhiều nước và không có hạt.'),
       (4, 1, 'Kiwi vàng Úc', 30, 250000, '/products/14.png',
        'Kiwi vàng có thịt quả màu vàng trong rất đẹp mắt, với nhiều hạt đen tạo thành 1 vòng tròn xung quanh trục dọc của quả. Kiwi vàng có vị ngọt thanh mát rất đặc trưng.'),
...
VALUES (1, 'ADMIN', 'admin@example.com', '0123456789', '$2y$10$I28YxXzeusOtIFG5rTqaQOaD1y/yOb5dThCME3QkQN83WY9QAc9eq',
        'admin'),
       (2, 'NGUYỄN VĂN A', 'nva@example.com', '0123456789',
        '$2y$10$/NtWnC3YkdgFYalW2jsad.gi.Ywel3.fNQr2v7AI0tV4o0vOAv6nS', 'customer'),
       (3, 'NGUYỄN TRẦN MINH HUỆ', 'nguyentranminhhue@gmail.com', '0123456789',
        '$2y$10$o7qHSQL/rtBHqJlLZyF0qeq5X9Xi6YVKpmxAyH33N6FD25TLGPlw.', 'customer'),
       (4, 'LÊ HOÀNG NAM', 'lehoangnam@gmail.com', '0123456789',
        '$2y$10$sh8iDrIwwtGimGbEtQM6SedmhPKuU/5vVpT0Y7HFmK4M/Bn4dJTz6', 'customer'),
       (5, 'LÊ THỊ NGỌC THANH', 'lethingocthanh@gmail.com', '0123456789',
        '$2y$10$5bpOi10r.t/PNyqQXrw8vOl8SNG0HTWFV0Zj.Hy.6J2KKdqizLvkW', 'customer'),
       (6, 'NGUYỄN THỊ THÚY LOAN', 'nguyenthithuyloan@gmail.com', '0123456789',
        '$2y$10$qMT/ljZZma2Gs4YQl4CM.ucT09IRaMOOSHMXBw/zpjsfWRUIDON6S', 'customer'),
       (7, 'NGUYỄN THỊ KIM HOÀNG', 'nguyenthikimhoang@gmail.com', '0123456789',
        '$2y$10$gvBY7BXxMdPtcss1yUOASOZ6iR5fUuIl87xWwzwaWvF.h0F4R/NMm', 'customer'),
       (8, 'NGUYỄN THỊ KIM YẾN', 'nguyenthikimyen@gmail.com', '0123456789',
        '$2y$10$6tYzxcIpONZku1FVdGFW8Oq3AbiCx0ECKCCnChODLHUIkEjWbffSa', 'customer'),
       (9, 'NGUYỄN THANH TÀI', 'nguyenthanhtai@gmail.com', '0123456789',
        '$2y$10$fsYzl2CEHrbyuKYPhqFANuAi.kQ2ngl4xoBl.GetzWGHaCgkxUUYe', 'customer'),
       (10, 'LÊ NGUYỄN HÙNG PHONG', 'lenguyenhungphong@gmail.com', '0123456789',
        '$2y$10$VGn/0RFyMiks/b6BmPojNuFLNSRzFQci5dHpx8ok3bABHJ7fDO3Ki', 'customer');
