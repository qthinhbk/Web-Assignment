                        ...
                        <div class="catalog-filter-row">
                            <ul class="uk-subnav uk-subnav-pill">
                                <li <?php if (!isset($_SESSION['category_id'])) echo "class='uk-active'" ?>
                                    ...
                                    <a onclick="document.getElementById('category-page').innerHTML = ''" href="#">Tất
                                        cả</a>
                                </li>
                                                ...
                                                <a href="<?php echo Utils\BASE_URL ?>/home/product/<?php echo $row["product_id"] ?>"
                                                   style="text-decoration: none;">
                                                    <div class="product-item__not-active">
                                                        <div class="product-item__media">
                                                            <div class="uk-inline-clip uk-transition-toggle uk-light"
                                                                 data-uk-lightbox="data-uk-lightbox"><img class=""
                                                                                                          href=""
                                                        ...
                                                        <div class="product-item__title"
                                                             style="text-align: center"><?php echo $row["product_name"] ?>
                                                        </div>
                                                    </div>
                                                    <div class="product-item__info">
                                                        ...
                                                        <br>
                                                        <button class="uk-button" style="width:100%">Xem sản phẩm
                                                        </button>
                                                    </div>
                                                </a>
