    ...
    Object.values(productItem).map(item => {
        ...
        if (myProduct == undefined) {
            container.innerHTML += '' +
                ...
                '<h5 class="product__quantity">' + '<span class="counter" style = "font-style: normal;"><span class="minus" onclick="subtractItem(\'' + item.tag + '\')">-</span><input type="text" value="' + item.quantity + '" /><span onclick="addItem(\'' + item.tag + '\')" class="plus">+</span></span>' + '</h5>' +
            ...
            childrens[2].innerHTML = '<span class="counter" style = "font-style: normal;"><span class="minus" onclick="subtractItem(\'' + item.tag + '\')">-</span><input type="text" value="' + item.quantity + '" /><span onclick="addItem(\'' + item.tag + '\')" class="plus">+</span></span>';
